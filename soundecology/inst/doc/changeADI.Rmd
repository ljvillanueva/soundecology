...
When revising the code, we found that there was an error in the code. The ADI was supposed to apply the Shannon's Diversity Index to the values of the bins, but the code had a different equation. It was the average of the sum of the logs:
...
*Version 1.0beta (18 October 2013)*
